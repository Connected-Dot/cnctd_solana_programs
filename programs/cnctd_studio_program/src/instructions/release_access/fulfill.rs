...
use crate::{arguments::{metadata::Creator, release_access::FulfillReleaseAccessArgs,}, errors::CnctdStudioError, state::{release_escrow::ReleaseEscrow, treasury::Treasury, user_pda::UserPDA}, utils::UuidFormatting};

#[derive(Accounts)]
#[instruction(args: FulfillReleaseAccessArgs)]
...
fn pay_treasury_fee(accounts: &mut FulfillReleaseAccess, args: &FulfillReleaseAccessArgs) -> Result<()> {
...
fn mint_nft(accounts: &mut FulfillReleaseAccess, args: &FulfillReleaseAccessArgs) -> Result<()> {
